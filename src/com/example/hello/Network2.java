...
public class Network2 {
	...
	public static List<Person> getJOSN1(String path) throws Exception{
		...
		for(int i = 0;i<array.length();i++){
			...
			mlist.add(new Person(num, name));
		}
		return mlist;
	}
	
	public static List<Person> getJOSN2(String path) throws Exception{
		List<Person> mlist = new ArrayList<Person>();
		String json = jsonString(path);
		JSONArray array = new JSONArray(json);
